...
PYBIND11_MODULE(_core, m) {
    ...
    .value("STATUS_SGX_ROOT_CA_INVALID_EXTENSIONS",STATUS_SGX_ROOT_CA_INVALID_EXTENSIONS)
    .value("STATUS_SGX_ROOT_CA_INVALID_ISSUER",STATUS_SGX_ROOT_CA_INVALID_ISSUER)
    .value("STATUS_SGX_ROOT_CA_UNTRUSTED",STATUS_SGX_ROOT_CA_UNTRUSTED)

    .value("STATUS_SGX_INTERMEDIATE_CA_MISSING",STATUS_SGX_INTERMEDIATE_CA_MISSING)
    .value("STATUS_SGX_INTERMEDIATE_CA_INVALID",STATUS_SGX_INTERMEDIATE_CA_INVALID)
    .value("STATUS_SGX_INTERMEDIATE_CA_INVALID_EXTENSIONS",STATUS_SGX_INTERMEDIATE_CA_INVALID_EXTENSIONS)
    .value("STATUS_SGX_INTERMEDIATE_CA_INVALID_ISSUER",STATUS_SGX_INTERMEDIATE_CA_INVALID_ISSUER)
    .value("STATUS_SGX_INTERMEDIATE_CA_REVOKED",STATUS_SGX_INTERMEDIATE_CA_REVOKED)

    .value("STATUS_SGX_PCK_MISSING",STATUS_SGX_PCK_MISSING)
    .value("STATUS_SGX_PCK_INVALID",STATUS_SGX_PCK_INVALID)
    .value("STATUS_SGX_PCK_INVALID_EXTENSIONS",STATUS_SGX_PCK_INVALID_EXTENSIONS)
    ...
    .value("STATUS_SGX_PCK_CERT_CHAIN_UNTRUSTED",STATUS_SGX_PCK_CERT_CHAIN_UNTRUSTED)

    .value("STATUS_SGX_TCB_INFO_UNSUPPORTED_FORMAT",STATUS_SGX_TCB_INFO_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_TCB_INFO_INVALID",STATUS_SGX_TCB_INFO_INVALID)            
    .value("STATUS_TCB_INFO_INVALID_SIGNATURE",STATUS_TCB_INFO_INVALID_SIGNATURE)

    .value("STATUS_SGX_TCB_SIGNING_CERT_MISSING",STATUS_SGX_TCB_SIGNING_CERT_MISSING)
    .value("STATUS_SGX_TCB_SIGNING_CERT_INVALID",STATUS_SGX_TCB_SIGNING_CERT_INVALID)
    .value("STATUS_SGX_TCB_SIGNING_CERT_INVALID_EXTENSIONS",STATUS_SGX_TCB_SIGNING_CERT_INVALID_EXTENSIONS)
    .value("STATUS_SGX_TCB_SIGNING_CERT_INVALID_ISSUER",STATUS_SGX_TCB_SIGNING_CERT_INVALID_ISSUER)
    .value("STATUS_SGX_TCB_SIGNING_CERT_CHAIN_UNTRUSTED",STATUS_SGX_TCB_SIGNING_CERT_CHAIN_UNTRUSTED)
    .value("STATUS_SGX_TCB_SIGNING_CERT_REVOKED",STATUS_SGX_TCB_SIGNING_CERT_REVOKED)

    .value("STATUS_SGX_CRL_UNSUPPORTED_FORMAT",STATUS_SGX_CRL_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_CRL_UNKNOWN_ISSUER",STATUS_SGX_CRL_UNKNOWN_ISSUER)
    .value("STATUS_SGX_CRL_INVALID",STATUS_SGX_CRL_INVALID)            
    .value("STATUS_SGX_CRL_INVALID_EXTENSIONS",STATUS_SGX_CRL_INVALID_EXTENSIONS)
    .value("STATUS_SGX_CRL_INVALID_SIGNATURE",STATUS_SGX_CRL_INVALID_SIGNATURE)


    .value("STATUS_SGX_CA_CERT_UNSUPPORTED_FORMAT",STATUS_SGX_CA_CERT_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_CA_CERT_INVALID",STATUS_SGX_CA_CERT_INVALID)
    .value("STATUS_TRUSTED_ROOT_CA_UNSUPPORTED_FORMAT",STATUS_TRUSTED_ROOT_CA_UNSUPPORTED_FORMAT)

    .value("STATUS_MISSING_PARAMETERS",STATUS_MISSING_PARAMETERS)

    .value("STATUS_UNSUPPORTED_QUOTE_FORMAT",STATUS_UNSUPPORTED_QUOTE_FORMAT)
    .value("STATUS_UNSUPPORTED_PCK_CERT_FORMAT",STATUS_UNSUPPORTED_PCK_CERT_FORMAT)
    .value("STATUS_INVALID_PCK_CERT",STATUS_INVALID_PCK_CERT)
    .value("STATUS_UNSUPPORTED_PCK_RL_FORMAT",STATUS_UNSUPPORTED_PCK_RL_FORMAT)
    .value("STATUS_INVALID_PCK_CRL",STATUS_INVALID_PCK_CRL)
    .value("STATUS_UNSUPPORTED_TCB_INFO_FORMAT",STATUS_UNSUPPORTED_TCB_INFO_FORMAT)
    ...
    .value("STATUS_TCB_CONFIGURATION_NEEDED",STATUS_TCB_CONFIGURATION_NEEDED)
    .value("STATUS_TCB_OUT_OF_DATE_CONFIGURATION_NEEDED",STATUS_TCB_OUT_OF_DATE_CONFIGURATION_NEEDED)
    ...
    .value("STATUS_UNSUPPORTED_QE_CERTIFICATION",STATUS_UNSUPPORTED_QE_CERTIFICATION)
    .value("STATUS_INVALID_QE_CERTIFICATION_DATA_SIZE",STATUS_INVALID_QE_CERTIFICATION_DATA_SIZE)
    .value("STATUS_UNSUPPORTED_QE_CERTIFICATION_DATA_TYPE",STATUS_UNSUPPORTED_QE_CERTIFICATION_DATA_TYPE)
    .value("STATUS_PCK_CERT_MISMATCH",STATUS_PCK_CERT_MISMATCH)
    .value("STATUS_INVALID_QE_REPORT_SIGNATURE",STATUS_INVALID_QE_REPORT_SIGNATURE)
    ...
    .value("STATUS_SGX_QE_IDENTITY_UNSUPPORTED_FORMAT",STATUS_SGX_QE_IDENTITY_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_QE_IDENTITY_INVALID",STATUS_SGX_QE_IDENTITY_INVALID)
    .value("STATUS_SGX_QE_IDENTITY_INVALID_SIGNATURE",STATUS_SGX_QE_IDENTITY_INVALID_SIGNATURE) 

    .value("STATUS_SGX_ENCLAVE_REPORT_UNSUPPORTED_FORMAT",STATUS_SGX_ENCLAVE_REPORT_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_ENCLAVE_IDENTITY_UNSUPPORTED_FORMAT",STATUS_SGX_ENCLAVE_IDENTITY_UNSUPPORTED_FORMAT)
    .value("STATUS_SGX_ENCLAVE_IDENTITY_INVALID",STATUS_SGX_ENCLAVE_IDENTITY_INVALID)
    .value("STATUS_SGX_ENCLAVE_IDENTITY_UNSUPPORTED_VERSION",STATUS_SGX_ENCLAVE_IDENTITY_UNSUPPORTED_VERSION)
    .value("STATUS_SGX_ENCLAVE_IDENTITY_OUT_OF_DATE",STATUS_SGX_ENCLAVE_IDENTITY_OUT_OF_DATE)
    .value("STATUS_SGX_ENCLAVE_REPORT_MISCSELECT_MISMATCH",STATUS_SGX_ENCLAVE_REPORT_MISCSELECT_MISMATCH)
    .value("STATUS_SGX_ENCLAVE_REPORT_ATTRIBUTES_MISMATCH",STATUS_SGX_ENCLAVE_REPORT_ATTRIBUTES_MISMATCH)
    .value("STATUS_SGX_ENCLAVE_REPORT_MRENCLAVE_MISMATCH",STATUS_SGX_ENCLAVE_REPORT_MRENCLAVE_MISMATCH)
    .value("STATUS_SGX_ENCLAVE_REPORT_MRSIGNER_MISMATCH",STATUS_SGX_ENCLAVE_REPORT_MRSIGNER_MISMATCH)
    .value("STATUS_SGX_ENCLAVE_REPORT_ISVPRODID_MISMATCH",STATUS_SGX_ENCLAVE_REPORT_ISVPRODID_MISMATCH) 
    .value("STATUS_SGX_ENCLAVE_REPORT_ISVSVN_OUT_OF_DATE",STATUS_SGX_ENCLAVE_REPORT_ISVSVN_OUT_OF_DATE)

    .value("STATUS_UNSUPPORTED_QE_IDENTITY_FORMAT",STATUS_UNSUPPORTED_QE_IDENTITY_FORMAT)
    ...
    .value("STATUS_SGX_ENCLAVE_IDENTITY_INVALID_SIGNATURE",STATUS_SGX_ENCLAVE_IDENTITY_INVALID_SIGNATURE)
    .value("STATUS_INVALID_PARAMETER",STATUS_INVALID_PARAMETER)
    .value("STATUS_SGX_PCK_CERT_CHAIN_EXPIRED",STATUS_SGX_PCK_CERT_CHAIN_EXPIRED)
    .value("STATUS_SGX_CRL_EXPIRED",STATUS_SGX_CRL_EXPIRED)
    .value("STATUS_SGX_SIGNING_CERT_CHAIN_EXPIRED",STATUS_SGX_SIGNING_CERT_CHAIN_EXPIRED)        
    .value("STATUS_SGX_ENCLAVE_IDENTITY_EXPIRED",STATUS_SGX_ENCLAVE_IDENTITY_EXPIRED)
    .value("STATUS_TCB_SW_HARDENING_NEEDED",STATUS_TCB_SW_HARDENING_NEEDED)
    .value("STATUS_TCB_CONFIGURATION_AND_SW_HARDENING_NEEDED",STATUS_TCB_CONFIGURATION_AND_SW_HARDENING_NEEDED)
    .value("STATUS_SGX_ENCLAVE_REPORT_ISVSVN_REVOKED",STATUS_SGX_ENCLAVE_REPORT_ISVSVN_REVOKED)
